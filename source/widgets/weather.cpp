...
void WeatherWidget::drawContents(int top_x, int top_y, int width, int height) {
    ...
    drawStringBaselineAligned(top_x + 16, top_y + 18, "22 C");
    ...
    drawStringBaselineAligned(top_x + 7, top_y + 38, "9A");
    drawStringBaselineAligned(top_x + 41, top_y + 38, "12P");
    drawStringBaselineAligned(top_x + 78, top_y + 38, "5P");

    drawIcon(LUCIDE_12_TABLE[LUCIDE_12_ICON_SUN],   top_x + 7,  top_y + 49, C_YELLOW);
    drawIcon(LUCIDE_12_TABLE[LUCIDE_12_ICON_CLOUD], top_x + 43, top_y + 49, C_GREY);
    drawIcon(LUCIDE_12_TABLE[LUCIDE_12_ICON_MOON],  top_x + 78, top_y + 49, C_BLUE_MAYA_BLUE);

    selectFont(FONT_PROGGY_10);
    ulSetTextColor(C_GREY);
    drawStringBaselineAligned(top_x + 7,  top_y + 64, "24");
    drawStringBaselineAligned(top_x + 43, top_y + 64, "19");
    drawStringBaselineAligned(top_x + 78, top_y + 64, "14");
}